...
const SingleSlider = ({ direction , textStyle}) => {
  ...
  const content = (
    <>
     <h1 className="text-[170px] leading-none p-0 m-0 mr-7 font-['Bebas_Neue'] whitespace-nowrap">
  ...
  return (
    ...
    >
      <div
        className={`flex  flex-nowrap  w-max ${textStyle === 'forward'?'text-[#592416]':'text-stroke-orange [&>*]:scale-x-[-1]'}
